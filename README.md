...
While [Quicklisp](https://www.quicklisp.org/) is not required to run Roan,
it is recommended.
...
The Roan manual is [available online](https://dfmorrison.github.io/) or [as a PDF file](https://dfmorrison.github.io/roan-manual.pdf).
